...
terraform {
  ...
  backend "s3" {
    ...
    key    = "opsfleet/infrastructure/opsfleet_dev_cluster_identity_tf_state"
    region = "eu-west-1"
  }
}
...
# Provider definitions for North Virginia Region
provider "aws" {
...
# Provider definitions for Ohio Region
provider "aws" {
...
# Provider definitions for North California Region
provider "aws" {
...
# Provider definitions for Oregon Region
provider "aws" {
...
# Provider definitions for Stockholm Region
provider "aws" {
...
# Provider definitions for London Region
provider "aws" {
